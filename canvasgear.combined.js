...
Cvgr.startCanvasGear = function() {
  ...
  for (var a = document.getElementsByTagName("canvas"), b = 0; b < a.length; b++) {
    if (!(-1 < a[b].outerHTML.indexOf("skipthis"))) {
      ...
      c.CmdsHash = Trekta.Util2.CmdlinParser.parse(c.Command);
      ...
      if (Cvgr.Func.executeFram_PrintInfoCanvas(a), d = c.AlgoName, d in Cvgr.Algos && ("Template" !== d || Cvgr.Vars.bTemplateSearchFinished) || c.bIsDefaultSettingDone) {
        ...
        if (b = Cvgr.Vars.aPiggyAlgoNames.indexOf(d), 0 <= b) {
          ...
          if (Cvgr.Vars.aPiggyAlgoNames.length > Cvgr.Vars.aPiggyCallbacks.length - 1) {
            ...
            Cvgr.Vars.sDebugPageHelper += "<br /> — pullScriptBehind " + f + " " + d;
            Trekta.Utils.pullScriptBehind(b, Cvgr.Vars.aPiggyCallbacks[f][0], Cvgr.Vars.aPiggyCallbacks[f][1]);
          }
        }
      }
    }
...
Cvgr.Algos.Ballist = {Hit:function(a, b) {
  ...
  for (b = 0; b < c.length; b++) {
    h = 6, e = d + 50 * c[b].X + parseInt(a.ShiftX, 10), f = d + 50 * c[b].Y + parseInt(a.ShiftY, 10), a.Context.beginPath(), a.Context.arc(e, f, h, 0, 2 * Math.PI, !1), a.Context.closePath(), a.Context.strokeStyle = "#4169e1", a.Context.lineWidth = 1, a.Context.stroke();
  }
...
Trekta.Util2.CmdlinParser = function() {
  Trekta.Util2.parse = function(a) {
    "undefined" === typeof a && (a = "");
    for (var b = [], c = !1, d = "", e = 0; e < a.length; e++) {
      " " !== a.charAt(e) && "=" !== a.charAt(e) || c ? '"' === a.charAt(e) ? c = !c : d += a.charAt(e) : (b.push(d), d = "", "=" === a.charAt(e) && b.push("="));
    }
    b.push(d);
    a = [];
    for (e = 0; e < b.length; e++) {
      "" !== b[e] && (c = b[e], a[c] = "<n/a>", "=" === b[e + 1] && (a[c] = b[e + 2], e++, e++));
    }
    return a;
  };
  return {parse:Trekta.Util2.parse};
}();
Trekta = Trekta || {};
Trekta.Utils = Trekta.Utils || {getFileNameFull:function() {
  ...
  if (Trekta.Utils.isScriptAlreadyLoaded(a)) {
    ...
    "undefined" !== typeof c && null !== c && (f.onerror = function() {
      c(a, d);
    });
    e.appendChild(f);
    return !0;
...
/* *** append _min.canvasgear.Hamster.js at pos 53231 *** */
...
/* *** append _min.canvasgear.MyAlgo.js at pos 111602 *** */
...
/* *** append _min.canvasgear.Noisy1.js at pos 112845 *** */
...
/* *** append _min.canvasgear.Template.js at pos 118617 *** */
...
/* *** append libs\howler\howler.min.js at pos 120019 *** */
