      ...
      if (Cvgr.Func.executeFram_PrintInfoCanvas(a), b = c.AlgoName, b in Cvgr.Algos && ("Template" !== b || Cvgr.Vars.bTemplateSearchFinished) || c.bIsDefaultSettingDone) {
        ...
        if (0 <= d) {
          ...
          if (Cvgr.Vars.aPiggyAlgoNames.length > Cvgr.Vars.aPiggyCallbacks.length - 1) {
            ...
            var e = Trekta.Utils.retrieveDafBaseFolderAbs("/canvasgear.combined.js");
            "" === e && (e = Trekta.Utils.retrieveDafBaseFolderAbs("/canvasgear.js"));
...
Cvgr.Func.initializeCanvas = function(a) {
  ...
  "yes" === a.PlaySound && (Cvgr.Vars.bSoundLibraryLoading = !0, b = Trekta.Utils.retrieveDafBaseFolderAbs("/canvasgear.combined.js"), "" === b && (b = Trekta.Utils.retrieveDafBaseFolderAbs("/canvasgear.js")), Trekta.Utils.pullScriptBehind(b + "/libs/howler/howler.min.js", Cvgr.Func.pullbehind_soundOnLoad("howler"), Cvgr.Func.pullbehind_soundOnError("howler")));
...
Trekta.Utils = Trekta.Utils || {getCookie:function(a) {
  ...
  for (b = 0; b < c.length; b++) {
    ...
    var e = c[b].substr(c[b].indexOf("=") + 1);
    d = d.replace(/^\s+|\s+$/g, "");
    if (d === a) {
      return e = unescape(e);
    }
  ...
  b = b || !1;
  var c = Trekta.Utils.getCookie(a), d = b;
  "true" === c ? d = !0 : "false" === c ? d = !1 : Trekta.Utils.setCookie(a, b.toString(), 7);
  return d;
  ...
  if (Trekta.Utils.getCookieBool("checkbox_yellowdebugpane")) {
    if ("complete" !== document.readyState) {
      ...
      if (0 < Trekta.Utils.InitialMessageCache.length) {
        for (var c = "", d = Trekta.Utils.InitialMessageCache.length - 1; 0 <= d; d--) {
          "" !== c && (c = "\n\n" + c), c = Trekta.Utils.InitialMessageCache[d] + c;
        }
        Trekta.Utils.InitialMessageCache.length = 0;
        a = '<div style="background-color:LightGreen; margin:1.1em; padding:0.7em;">' + c + "</div>\n\n" + a;
      }
      a = a.replace(/\n/g, "<br />");
  ...
  if (Trekta.Utils.bUseMinified) {
    var e = /.*\/highlight.pack.js$/.test(a), f = /.*\/showdown.min.js$/.test(a), g = /.*\/sitmapdaf.js$/.test(a);
    e || f || g || (a = a.replace(/\.js$/, ".min.js"));
  }
  if (0 <= Trekta.Utils.aPulled.indexOf(a)) {
    ...
    if ("undefined" !== typeof b) {
      ...
      f.onload = function() {
        Trekta.Utils.pullScript_onload(a, h);
      };
    }
    c = c || null;
  ...
  b();
}, readTextFile2:function(a, b, c) {
  Trekta.Utils.ajax3Send("GET", a, "", b, c);
}, ajax3Send:function(a, b, c, d, e) {
  ...
  if (Trekta.Utils.bUseMinified) {
    var b = /.*\/highlight.pack.js$/.test(a), c = /.*\/showdown.min.js$/.test(a), d = /.*\/sitmapdaf.js$/.test(a);
    b || c || d || (a = a.replace(/\.js$/, ".min.js"));
  }
  b = a.replace(/\./g, "\\.") + "$";
  a = new RegExp(b, "");
  b = new RegExp("(.*)" + b, "");
...
/* *** append _min.canvasgear.Hamster.js at pos 57781 *** */
...
/* *** append _min.canvasgear.MyAlgo.js at pos 116131 *** */
...
/* *** append _min.canvasgear.Noisy1.js at pos 117353 *** */
...
/* *** append _min.canvasgear.Template.js at pos 123125 *** */
...
/* *** append libs\howler\howler.min.js at pos 124506 *** */
