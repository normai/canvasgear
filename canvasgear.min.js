...
Cvgr.Const = {versionnumber:"0.2.0.a", versiontimestamp:"20190330\u00b00757..", bShow_Debug_Dialogs:!1};
Cvgr.Func = {};
Cvgr.Objs = {};
Cvgr.Vars = {bFlagTipTopTest:!1, bIsNotFirstFrame:!1, iTimeStart:0, iTimeStartMs:0};
...
Cvgr.startCanvasGear = function() {
  ...
  for (var a = document.getElementsByTagName("canvas"), b = 0; b < a.length; b++) {
    if (!(-1 < a[b].outerHTML.indexOf("skipthis"))) {
      ...
      Cvgr.startCanvasGr_evalCmdlin(c);
...
Cvgr.startCanvasGr_evalCmdlin = function(a) {
  null === a.CmdsHash.bgcolor || void 0 === a.CmdsHash.bgcolor || "" === a.CmdsHash.bgcolor ? a.BgColor = "Transparent" : (a.BgColor = a.CmdsHash.bgcolor, "#" !== a.BgColor.substr(0, 1) && (a.BgColor = Trekta.Util2.colorNameToHex(a.BgColor)));
  void 0 === a.CmdsHash.color || null === a.CmdsHash.color || "" === a.CmdsHash.color ? a.Color = "LightSlateGray" : (a.Color = a.CmdsHash.color || "", "#" !== a.Color.substr(0, 1) && (a.Color = Trekta.Util2.colorNameToHex(a.Color)));
  "#" !== a.Color.substr(0, 1) ? a.Color2 = "SlateGray" : (a.Color2 = a.CmdsHash.color2 || "", "#" !== a.Color2.substr(0, 1) && (a.Color2 = Trekta.Util2.colorNameToHex(a.Color2)));
  void 0 === a.CmdsHash.color3 || null === a.CmdsHash.color3 || "" === a.CmdsHash.color3 ? a.Color3 = "DarkSlateGray" : (a.Color3 = a.CmdsHash.color3 || "", "#" !== a.Color3.substr(0, 1) && (a.Color3 = Trekta.Util2.colorNameToHex(a.Color3)));
  a.Hertz = void 0 === a.CmdsHash.hertz || null === a.CmdsHash.hertz || "" === a.CmdsHash.hertz ? 0.2 : a.CmdsHash.hertz;
  a.ShiftX = void 0 === a.CmdsHash.shiftx || null === a.CmdsHash.shiftx || "" === a.CmdsHash.shiftx ? 0 : a.CmdsHash.shiftx;
  a.ShiftY = void 0 === a.CmdsHash.shifty || null === a.CmdsHash.shifty || "" === a.CmdsHash.shifty ? 0 : a.CmdsHash.shifty;
  a.Speed = void 0 === a.CmdsHash.speed || null === a.CmdsHash.speed || "" === a.CmdsHash.speed ? 444 : a.CmdsHash.speed;
  a.SizeFactor = "SizeFactor" in a.CmdsHash ? a.CmdsHash.SizeFactor : 1.0;
};
...
Cvgr.Func.examineAlgo = function(a, b) {
  "undefined" !== typeof a && (b.AlgoName in Cvgr.Algos ? Cvgr.Vars.timSuccess[a] = !0 : b.AlgoName = "pulse");
};
Cvgr.Func.executeFramContinue = function(a, b) {
  Cvgr.Vars.bIsNotFirstFrame = !0;
...
Cvgr.Func.executeFrame = function() {
  ...
  for (var d = 0; d < Cvgr.Vars.icos.length; d++) {
    Cvgr.Func.executeFram_PrintInfo(d), a = Cvgr.Vars.icos[d].AlgoName, a in Cvgr.Algos && "Template" !== a || Cvgr.Vars.bIsNotFirstFrame && "Template" === a ? Cvgr.Algos[a].executeAlgorithm(Cvgr.Vars.icos[d]) : (a = Trekta.Utils.retrieveScriptFolderAbs("canvasgear.js") + "canvasgear." + a + ".js", Cvgr.Vars.timSuccess.push(!1), Cvgr.Vars.timrs.push(setTimeout(Cvgr.Func.examineAlgo, 1357, Cvgr.Vars.timrs.length - 1, Cvgr.Vars.icos[d])), Trekta.Utils.pullScriptBehind(a, function() {
...
}, defaultProperties:{bgcolor:"LightCyan", color1:"LightCoral", color2:"PaleGreen", color3:"LightBlue", DrawOnlyOnce:!0}};
