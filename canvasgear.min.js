...
Cvgr.startCanvasGear = function() {
  ...
  for (var a = document.getElementsByTagName("canvas"), b = 0; b < a.length; b++) {
    if (!(-1 < a[b].outerHTML.indexOf("skipthis"))) {
      ...
      c.Width = c.Canvas.height;
      c.Height = c.Canvas.width;
      c.Command = "";
      c.Command = void 0 !== c.Canvas.attributes["data-cvgr"] ? c.Canvas.attributes["data-cvgr"].value : Cvgr.Func.findComments3(c.Canvas.nextSibling);
      c.CmdHash2 = Trekta.Util2.CmdlinParser.parse(c.Command, !0);
      ...
      if (Cvgr.Const.bShow_Debug_Dialogs) {
        ...
        e += "\n[x] ico.Canvas = " + c.Canvas;
        e += "\n[x] ico.Height = " + c.Height;
        e += "\n[x] ico.Ide = " + c.Ide;
        e += "\n[x] ico.Width = " + c.Width;
        e += "\n\nElement properties :";
        for (sKey in a[b]) {
        ...
        e += "\n\nCommandline values :";
        for (sKey in c.CmdHash2) {
          e += "\n[o] " + sKey + " = " + c.CmdHash2[sKey];
        }
        alert("[Debug 20140926\u00b00332] Canvas element:\n" + e);
      }
      c.AlgoName = void 0 === c.CmdHash2.algo || null === c.CmdHash2.algo || "" === c.CmdHash2.algo ? "default" : c.CmdHash2.algo;
      null === c.CmdHash2.bgcolor || void 0 === c.CmdHash2.bgcolor || "" === c.CmdHash2.bgcolor ? c.BgColor = "Transparent" : (c.BgColor = c.CmdHash2.bgcolor, "#" !== c.BgColor.substr(0, 1) && (c.BgColor = Trekta.Util2.colorNameToHex(c.BgColor)));
      void 0 === c.CmdHash2.color || null === c.CmdHash2.color || "" === c.CmdHash2.color ? c.Color = "LightSlateGray" : (c.Color = c.CmdHash2.color || "", "#" !== c.Color.substr(0, 1) && (c.Color = Trekta.Util2.colorNameToHex(c.Color)));
      "#" !== c.Color.substr(0, 1) ? c.Color2 = "SlateGray" : (c.Color2 = c.CmdHash2.color2 || "", "#" !== c.Color2.substr(0, 1) && (c.Color2 = Trekta.Util2.colorNameToHex(c.Color2)));
      void 0 === c.CmdHash2.color3 || null === c.CmdHash2.color3 || "" === c.CmdHash2.color3 ? c.Color3 = "DarkSlateGray" : (c.Color3 = c.CmdHash2.color3 || "", "#" !== c.Color3.substr(0, 1) && (c.Color3 = Trekta.Util2.colorNameToHex(c.Color3)));
      c.Hertz = void 0 === c.CmdHash2.hertz || null === c.CmdHash2.hertz || "" === c.CmdHash2.hertz ? 0.2 : c.CmdHash2.hertz;
      c.ShiftX = void 0 === c.CmdHash2.shiftx || null === c.CmdHash2.shiftx || "" === c.CmdHash2.shiftx ? 0 : c.CmdHash2.shiftx;
      c.ShiftY = void 0 === c.CmdHash2.shifty || null === c.CmdHash2.shifty || "" === c.CmdHash2.shifty ? 0 : c.CmdHash2.shifty;
      c.Speed = void 0 === c.CmdHash2.speed || null === c.CmdHash2.speed || "" === c.CmdHash2.speed ? 444 : c.CmdHash2.speed;
      c.SizeFactor = "SizeFactor" in c.CmdHash2 ? c.CmdHash2.SizeFactor : 1.0;
  ...
  if ("undefined" !== typeof window.bIs_IE8_ExcanvasLoaded && bIs_IE8_LocalExcanvasLoaded) {
    for (b = 0; b < Cvgr.Vars.icos.length; b++) {
      G_vmlCanvasManager.initElement(Cvgr.Vars.icos[b].Canvas);
    }
  }
...
Cvgr.Func.algoDevelop = function(a, b) {
  a = a[b];
  if (!a.DrawOnlyOnce) {
    a.DrawOnlyOnce = !0;
    ...
    b = [];
    var d = new Cvgr.Objs.Line(3, 3, c - 3, 3, "crimson"), e = new Cvgr.Objs.Line(4, c - 4, c - 4, c - 4, "seagreen");
    c = new Cvgr.Objs.Line(5, c - 7, c - 5, 7, "royalblue");
    b.push(d);
    b.push(e);
    b.push(c);
    for (d = 0; d < b.length; d++) {
      a.Context.beginPath(), a.Context.moveTo(b[d].X1, b[d].Y1), a.Context.lineTo(b[d].X2, b[d].Y2), a.Context.lineWidth = 3, a.Context.strokeStyle = b[d].Colo, a.Context.stroke();
    }
  }
};
Cvgr.Func.algoOblongrose = function(a, b) {
  a = a[b];
  if (!a.DrawOnlyOnce) {
    a.DrawOnlyOnce = !0;
    b = (+a.Width + +a.Height) / 2;
    a.Context.clearRect(0, 0, a.Canvas.width, a.Canvas.height);
    a.Context.strokeStyle = a.Color;
    a.Context.fillStyle = "#ffff00";
    a.Context.translate(b / 2, b / 2);
    for (var c = 0; 16 > c; c++) {
      a.Context.rotate(2 * Math.PI / 16), a.Context.strokeRect(0, 0, b / 2, b / 6);
    }
  }
};
Cvgr.Func.algoPulse = function(a, b) {
  var c = a[b];
  c.Context.clearRect(0, 0, c.Canvas.width, c.Canvas.height);
  c.Context.fillStyle = "#f0f0f0";
  c.Context.fillRect(0, 0, c.Canvas.width, c.Canvas.height);
  var d = c.Width > c.Height ? c.Width : c.Height;
  d *= c.SizeFactor;
  d /= 2;
  var e = d * Math.abs(Math.cos(c.Angle));
  var f = d + parseInt(c.ShiftX, 10);
  d += parseInt(c.ShiftY, 10);
  c.Context.beginPath();
  c.Context.arc(f, d, e, 0, 2 * Math.PI, !1);
  c.Context.closePath();
  c.Context.fillStyle = c.Color;
  c.Context.fill();
  c.Angle += Cvgr.Vars.nIncTurnsPerFrame * Math.PI * a[b].Hertz;
};
Cvgr.Func.algoTriangle = function(a, b) {
  a = a[b];
  b = (+a.Width + +a.Height) / 2;
  var c = 0.5 * b, d = 0.01 * b, e = 0.8 * b, f = 0.9 * b, h = 0.2 * b;
  a.Context.clearRect(0, 0, a.Canvas.width, a.Canvas.height);
  a.Context.translate(b / 2, b / 2);
  ...
  a.Context.lineTo(h, f);
  a.Context.fillStyle = a.Color;
  a.Context.fill();
  a.Context.closePath();
};
Cvgr.Func.algoTriangulum = function(a, b) {
  a = a[b];
  b = (+a.Width + +a.Height) / 2;
  ...
  a.Angle > b - 4 && (a.Angle = 0);
};
Cvgr.Func.examineAlgo = function(a, b) {
  Cvgr.Vars.icos[b].AlgoName in Cvgr.Algos ? Cvgr.Vars.timSuccess[a] = !0 : Cvgr.Vars.icos[b].AlgoName = "pulse";
};
Cvgr.Func.executeFrame = function() {
  ...
  if (null !== d) {
    ...
    e = e + ("<br />Current time = " + a) + ("<br />Elapsed seconds (every two) = " + b + ";") + ("<br />Frames per seconds (total, average since start) = " + c);
  ...
  for (var f = 0; f < Cvgr.Vars.icos.length; f++) {
    a = document.getElementById(Cvgr.Vars.icos[f].Ide + ".info");
    if (null !== a) {
      c = "<small>CanvasGear Canvas Debug Info :";
      b = 1;
      b = Math.floor(10 * Cvgr.Vars.icos[f].Angle);
      c += "<br />iko.Angle = " + b + "<br />iko.Color = " + Cvgr.Vars.icos[f].Color + "<br />iko.Height = " + Cvgr.Vars.icos[f].Height + "<br />iko.Mode = " + (Cvgr.Vars.bFlagTipTopTest ? "Top" : "Tip") + "<br />iko.Width = " + Cvgr.Vars.icos[f].Width;
      for (ki in Cvgr.Vars.icos[f].CmdHash2) {
        b = Trekta.Utils.htmlEscape(Cvgr.Vars.icos[f].CmdHash2[ki]), c += "<br /> [cmd] " + ki + " = " + b;
      }
      c += "</small>";
      a.innerHTML = c;
    }
    a = Cvgr.Vars.icos[f].AlgoName;
    "develop" === a ? Cvgr.Func.algoDevelop(Cvgr.Vars.icos, f) : "oblongrose" === a ? Cvgr.Func.algoOblongrose(Cvgr.Vars.icos, f) : "pulse" === a ? Cvgr.Func.algoPulse(Cvgr.Vars.icos, f) : "triangle" === a ? Cvgr.Func.algoTriangle(Cvgr.Vars.icos, f) : "triangulum" === a ? Cvgr.Func.algoTriangulum(Cvgr.Vars.icos, f) : a in Cvgr.Algos ? Cvgr.Algos[a].executeAlgorithm(Cvgr.Vars.icos, f) : (a = Trekta.Utils.retrieveScriptFolderAbs("canvasgear.js") + "canvasgear." + a + ".js", Cvgr.Vars.timSuccess.push(!1), 
    Cvgr.Vars.timrs.push(setTimeout(Cvgr.Func.examineAlgo, 1357, Cvgr.Vars.timrs.length - 1, f)), Trekta.Utils.pullScriptBehind(a, function() {
      Cvgr.Func.executeFrameContinu(f);
    }));
  }
  window.requestAnimFrame(Cvgr.Func.executeFrame);
};
Cvgr.Func.executeFrameContinu = function(a, b) {
  a in Cvgr.Algos && Cvgr.Algos[a].executeAlgorithm(Cvgr.Vars.icos, b);
};
...
Cvgr.Algos.Ballist.Ring = function(a, b, c, d) {
  null === a && (a = "?");
  null === b && (b = 0.987);
  null === c && (c = "gray");
  null === d && (d = "white");
...
Cvgr.Algos.Ballist.executeAlgo_drawDiagonal = function(a) {
  ...
  a.CmdHash2.text && (a.Context.fillStyle = "#102030", a.Context.font = "1.2em Arial", a.Context.fillText(a.CmdHash2.text, 10, 20));
};
Cvgr.Algos.Ballist.executeAlgo_getSeries = function(a) {
  var b = [];
...
Cvgr.Algos.Ballist.executeAlgo_getTarget = function(a) {
...
Cvgr.Algos.Ballist.executeAlgorithm = function(a, b) {
  a = a[b];
  if (!a.DrawOnlyOnce) {
    a.DrawOnlyOnce = !0;
    b = (+a.Width + +a.Height) / 2;
    var c = Cvgr.Algos.Ballist.executeAlgo_getTarget(), d = Cvgr.Algos.Ballist.executeAlgo_getSeries(a.CmdHash2.series);
    a.Context.clearRect(0, 0, a.Canvas.width, a.Canvas.height);
    a.Context.fillStyle = a.BgColor;
    a.Context.fillRect(0, 0, a.Canvas.width, a.Canvas.height);
    var e = (a.Width + a.Height) / 4, f = e, h = e;
    null !== a.ShiftX && (f = e + parseInt(a.ShiftX, 10));
    null !== a.ShiftY && (h = e + parseInt(a.ShiftY, 10));
    for (var g = 0; g < c.rings.length; g++) {
      var k = e * c.rings[g].radiusAbs * 12;
      a.Context.beginPath();
      a.Context.arc(f, h, k, 0, 2 * Math.PI, !1);
      a.Context.closePath();
      a.Context.strokeStyle = Trekta.Util2.colorNameToHex(c.rings[g].colorRing);
      a.Context.lineWidth = 1;
      a.Context.stroke();
    }
    for (c = 0; c < d.length; c++) {
      k = 6, f = e + 50 * d[c].X + parseInt(a.ShiftX, 10), h = e + 50 * d[c].Y + parseInt(a.ShiftY, 10), a.Context.beginPath(), a.Context.arc(f, h, k, 0, 2 * Math.PI, !1), a.Context.closePath(), a.Context.strokeStyle = "#4169e1", a.Context.lineWidth = 1, a.Context.stroke();
    }
...
Trekta.Util2.CmdlinParser = function() {
  parse = function(a, b) {
    void 0 === a && (a = "");
    for (var c = [], d = !1, e = "", f = 0; f < a.length; f++) {
      " " !== a.charAt(f) && "=" !== a.charAt(f) || d ? '"' === a.charAt(f) && b ? d = !d : e += a.charAt(f) : (c.push(e), e = "", "=" === a.charAt(f) && c.push("="));
    }
    c.push(e);
    a = [];
    for (f = 0; f < c.length; f++) {
      "" !== c[f] && (b = c[f], a[b] = "<n/a>", "=" === c[f + 1] && (a[b] = c[f + 2], f++, f++));
    }
    return a;
  };
  return {parse:parse};
