...
Cvgr.Const = {versionnumber:"0.2.0.e", versiontimestamp:"20190331\u00b00421", bShow_Debug_Dialogs:!1};
Cvgr.Func = {};
Cvgr.Objs = {};
...
Cvgr.Func.examineAlgo = function(a, b) {
  ...
  if (b.AlgoName in Cvgr.Algos) {
    ...
    for (var d = Cvgr.Vars.aPiggyIconArrays[a], e = 0; e < d.length; e++) {
      Cvgr.Vars.aPiggyIconArrays[a][e].AlgoName = "pulse";
    }
  }
  Cvgr.Vars.sDebugPageHelper += "<br /> \u2014 examineAlgo : piggy " + a + " &nbsp; onLoad = " + Cvgr.Vars.aPiggyFlags4OnLoad[a] + " &nbsp; onError = " + Cvgr.Vars.aPiggyFlags4OnError[a] + " &nbsp; avail = " + Cvgr.Vars.aPiggyFlags4Avail[a] + " &nbsp; algo = " + c + " / " + b.AlgoName;
};
...
Cvgr.Func.executeFrame = function() {
  ...
  for (a = 0; a < Cvgr.Vars.icos.length; a++) {
    if (c = Cvgr.Vars.icos[a], Cvgr.Func.executeFram_PrintInfoCanvas(a), b = c.AlgoName, b in Cvgr.Algos && ("Template" !== b || Cvgr.Vars.bTemplateSearchFinished) || c.bIsDefaultSettingDone) {
      ...
      if (0 <= d) {
        ...
        Cvgr.Vars.aPiggyFlags4OnError.push(!1);
        Cvgr.Vars.aPiggyFlags4OnLoad.push(!1);
        Cvgr.Vars.aPiggyTimers.push(setTimeout(Cvgr.Func.examineAlgo, 1444, Cvgr.Vars.aPiggyTimers.length, Cvgr.Vars.icos[a]));
        Cvgr.Vars.sDebugPageHelper += "<br /> \u2014 pullScriptBehind " + g + " " + b;
        Trekta.Utils.pullScriptBehind(d, Cvgr.Vars.aPiggyCallbacks[g][0], Cvgr.Vars.aPiggyCallbacks[g][1]);
        Trekta.Utils.pullScriptBehind(e, Cvgr.Vars.aPiggyCallbacks[g][3], Cvgr.Vars.aPiggyCallbacks[g][4]);
      }
    }
  }
...
Cvgr.Func.pullbehind_onError = function(a) {
  Cvgr.Vars.aPiggyFlags4OnError[a] = !0;
  ...
  if (Cvgr.Vars.aPiggyAlgoNames[a] in Cvgr.Algos) {
    ...
    for (var b = Cvgr.Vars.aPiggyIconArrays[a], c = 0; c < b.length; c++) {
      Cvgr.Vars.aPiggyIconArrays[a][c].AlgoName = "pulse";
    }
  }
  Cvgr.Vars.sDebugPageHelper += "<br /> \u2014 pullbehind_onError : &nbsp; piggy " + a + ' &nbsp; "' + Cvgr.Vars.aPiggyAlgoNames[a] + '" &nbsp; onload = ' + Cvgr.Vars.aPiggyFlags4OnLoad[a] + " &nbsp; onerror = " + Cvgr.Vars.aPiggyFlags4OnError[a];
};
Cvgr.Func.pullbehind_onLoad = function(a) {
  Cvgr.Vars.aPiggyFlags4OnLoad[a] = !0;
  Cvgr.Vars.bTemplateSearchFinished = !0;
