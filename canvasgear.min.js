...
Cvgr.Const = {versionnumber:"0.2.1", versiontimestamp:"20190401\u00b00551", bShow_Debug_Dialogs:!1};
Cvgr.Func = {};
Cvgr.Objs = {};
  ...
  if (!1 === Cvgr.Vars.aPiggyFlags4OnError1[a]) {
    ...
    if (Cvgr.Vars.aPiggyAlgoNames[a] in Cvgr.Algos) {
      ...
      for (var b = Cvgr.Vars.aPiggyIconArrays[a], c = 0; c < b.length; c++) {
        Cvgr.Vars.aPiggyIconArrays[a][c].CmdsHash.text = "Template intern " + c, Cvgr.Vars.aPiggyIconArrays[a][c].iFrameDelay = Cvgr.Vars.iFrameNo - 1, Cvgr.Func.settleAlgoProperties(Cvgr.Vars.aPiggyIconArrays[a][c]);
      }
    } else {
