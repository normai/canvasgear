...
Cvgr.Const = {versionnumber:"0.2.0.h..", versiontimestamp:"20190331\u00b00631", bShow_Debug_Dialogs:!1};
Cvgr.Func = {};
Cvgr.Objs = {};
      ...
      if (Cvgr.Func.executeFram_PrintInfoCanvas(a), d = c.AlgoName, d in Cvgr.Algos && ("Template" !== d || Cvgr.Vars.bTemplateSearchFinished) || c.bIsDefaultSettingDone) {
        ...
        if (b = Cvgr.Vars.aPiggyAlgoNames.indexOf(d), 0 <= b) {
          ...
          if (Cvgr.Vars.aPiggyAlgoNames.length > Cvgr.Vars.aPiggyCallbacks.length - 1) {
            ...
            Trekta.Utils.pullScriptBehind(e, Cvgr.Vars.aPiggyCallbacks[g][0], Cvgr.Vars.aPiggyCallbacks[g][1]);
            Trekta.Utils.pullScriptBehind(b, Cvgr.Vars.aPiggyCallbacks[g][3], Cvgr.Vars.aPiggyCallbacks[g][4]);
          }
        }
      }
    }
...
Cvgr.Func.pullbehind_onError = function(a) {
  ...
  if (Cvgr.Vars.aPiggyAlgoNames[a] in Cvgr.Algos) {
    ...
    for (var b = Cvgr.Vars.aPiggyIconArrays[a], c = 0; c < b.length; c++) {
      Cvgr.Vars.aPiggyIconArrays[a][c].AlgoName = "pulse", Cvgr.Vars.aPiggyIconArrays[a][c].CmdsHash.text = "Rp " + c, Cvgr.Vars.aPiggyIconArrays[a][c].iFrameDelay = Cvgr.Vars.iFrameNo - 1, Cvgr.Func.settleAlgoProperties(Cvgr.Vars.aPiggyIconArrays[a][c]);
    }
  }
...
Cvgr.Func.pullbehind_onLoad = function(a) {
  ...
  for (var c = 0; c < a.length; c++) {
    ...
    b in Cvgr.Algos && (d.bIsDefaultSettingDone || Cvgr.Func.settleAlgoProperties(d), d.iFrameDelay = Cvgr.Vars.iFrameNo - 1, Cvgr.Algos[d.AlgoName].executeAlgorithm(d));
  }
};
